...
async function getAuthClient() {
  ...
  if (process.env.GOOGLE_SERVICE_ACCOUNT_JSON) {
    try {
      ...
      console.error('Error: GOOGLE_SERVICE_ACCOUNT_JSON environment variable is not valid JSON.');
      process.exit(1);
    }
  } else {
    ...
    if (!credPath) {
      ...
      console.error('Set GOOGLE_SERVICE_ACCOUNT_KEY or GOOGLE_SERVICE_ACCOUNT_JSON env var.');
      process.exit(1);
    }
